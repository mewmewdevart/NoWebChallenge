...
function PackageCard({
    ...
    return (
        <div className="flex flex-col bg-white outline outline-light-gray rounded-[24px] p-4 h-full">
            <img
                src={imageSrc}
                alt={title}
                loading="lazy"
            ...
            <div className="flex justify-between mb-3 text-sm sm:text-base">
                <div className="flex flex-col gap-1 w-1/2">
                    <span className="font-medium text-charcoal ">Atendimento</span>
                    <span className="text-silver">{atendimentoValor}</span>
                </div>
                <div className="flex flex-col gap-1 w-1/2">
                    <span className="font-medium text-charcoal ">Tempo</span>
            ...
            <div className="flex items-center justify-between mt-auto">
                ...
                <ButtonComponent
                    ...
                    size="small"
                    className='font-semibold py-2.5 px-4 sm:px-5 rounded-[40px] text-xs sm:text-sm h-auto min-w-[100px] sm:min-w-[115px] h-[54px]'
                />
            </div>
        </div>
    );
...
function SpecialPackage(): JSX.Element {
    ...
    return (
        <section className='flex flex-col w-full px-4 lg2:px-20 2xl:px-48 3xl:px-60 pt-8 lg2:py-20'>
            <BadgeComponent
                label="Pacotes"
                variant="fullYellow"
                size="small"
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center mb-8">
                ...
                <div className="flex gap-3 sm:gap-4 items-center">
                    <ButtonComponent
                        ...
                        rightIcon={<ArrowBackIcon className={`w-[20px] h-[20px] sm:w-[24px] sm:h-[24px] ${effectivePrevDisabled ? 'text-silver' : 'text-dark-blue'}`} />}
                    />
                    <ButtonComponent
                        onClick={handleNext}
                        ...
                        rightIcon={<EastIcon className={`w-[20px] h-[20px] sm:w-[24px] sm:h-[24px] ${effectiveNextDisabled ? 'text-silver' : 'text-white'}`} />}
                    />
                </div>
            </div>
